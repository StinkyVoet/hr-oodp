class Company
{
    ...
    private int CalculateTravelAllowance(Employee employee, int howManyDistantEmployees)
    {
        ...
        try
        {
            var extraTravelAllowanceDistant = Math.Min(ExtraTravelAllowanceBudget / (howManyDistantEmployees - 1), MaxExtraTravelAllowance);
            var extraTravelAllowanceClose = Math.Min((ExtraTravelAllowanceBudget - extraTravelAllowanceDistant * howManyDistantEmployees) / (howManyCloseEmployees - 1), 100);
